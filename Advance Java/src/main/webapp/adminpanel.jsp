...
<nav>
    ...
    <div style="display: flex; align-items: center; gap: 20px;">
      <a href="userinfo.jsp" style="color: white; text-decoration: underline; font-weight: bold;">Hello, <%= username != null ? username : "Admin" %></a>
...
function beforeedit() {
  ...
  if (id && !isNaN(id)) {
    window.location.href = 'EditQuizServlet?id=' + id;
  }
}
</script>
