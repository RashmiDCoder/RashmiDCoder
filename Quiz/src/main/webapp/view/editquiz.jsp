...
<body>
<%
  // Fetch question from request attribute
  Question question = (Question) request.getAttribute("question");
  // Display edit form if question is found
  if (question != null) {
%>
<!-- Edit Quiz Form -->
<form action="<%= request.getContextPath() %>/EditQuizServlet" method="post" onsubmit="return confirm('Are you sure you want to update this question?');">
  <h2>Edit Quiz</h2>
